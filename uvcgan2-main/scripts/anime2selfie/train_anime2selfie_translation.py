...
def parse_cmdargs():
    parser = argparse.ArgumentParser(
        description = 'Train Anime2Selfie I2I model'
    )
...
def get_transfer_preset(cmdargs):
    ...
    base_model = (
        '/content/drive/MyDrive/uvcgan2/output2/checkpoints/'
...
# args
    ...
    'outdir' : os.path.join(ROOT_OUTDIR, '/content/drive/MyDrive/uvcgan2/trained', '/content/drive/MyDrive/uvcgan2/trained/anime_para2'),
    'log_level'  : 'DEBUG',
    'checkpoint' : 2,
}
